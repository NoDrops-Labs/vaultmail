...
import { Copy, MailPlus, Shield, ArrowLeft } from 'lucide-react';
        ...
        <div className="glass-card rounded-2xl border border-white/10 bg-white/5 p-4 md:p-8 space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2 text-white">
              <MailPlus className="h-5 w-5" style={{ color: 'var(--accent, #93c5fd)' }} />
              <h1 className="text-xl md:text-2xl font-semibold">{t.gmailDotTitle}</h1>
            </div>
            <p className="text-muted-foreground max-w-2xl text-sm md:text-base">{t.gmailDotSubtitle}</p>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-black/40 p-4 space-y-3">
            ...
            {localPart ? (
              ...
              <p className="text-xs md:text-sm text-white/50">{t.gmailDotEmpty}</p>
            )}
          </div>
        </div>
      </section>
